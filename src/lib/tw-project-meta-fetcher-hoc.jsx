...
export const fetchProjectMeta = async projectId => {
    const urls = [
        `https://trampoline.sailfish.org/api/projects/${projectId}`,
        `https://trampoline.sailfish.xyz/api/projects/${projectId}`
    ];
    let firstError;
            ...
            if (this.props.reduxProjectId !== prevProps.reduxProjectId) {
                ...
                if (projectId === '0') {
                    ...
                    fetchProjectMeta(projectId).then(data => {
                        ...
                        const authorThumbnail = `https://trampoline.sailfish.org/avatars/${data.author.id}`;
