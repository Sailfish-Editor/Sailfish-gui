...
const isTrustedExtension = url => (
    ...
    url.startsWith('https://extensions.sailfish.org/') ||
...
const isAlwaysTrustedForFetching = parsed => (
    ...
    // Any Sailfish service such as trampoline
    parsed.origin === 'https://sailfish.org' ||
    parsed.origin.endsWith('.sailfish.org') ||
    parsed.origin.endsWith('.sailfish.xyz') ||
