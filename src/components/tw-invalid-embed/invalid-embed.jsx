...
const InvalidEmbed = () => (
    <div className={styles.container}>
        ...
        <p>
            {'See '}
            <a
                href="https://docs.sailfish.org/embedding"
                target="_blank"
                rel="noreferrer"
            >
                {'docs.sailfish.org/embedding'}
            </a>
            {/* eslint-disable-next-line max-len */}
            {' for more information. You need to replace the iframe src with the embed page:'}
        </p>
        <p className={styles.code}>
            {'https://sailfish.org/<project ID>/embed'}
        </p>
        <p>
            {'Here\'s an example of a full iframe to embed a project:'}
        </p>
        <p className={styles.code}>
            {`<iframe src="https://sailfish.org/60917032/embed" width="482" height="412" allowtransparency="true" frameborder="0" scrolling="no" allowfullscreen></iframe>`}
        </p>
        <p>
