...
const NewsBody = () => (
    <div className={styles.text}>
        ...
        {`The Google Play Store app calling itself Sailfish is illegitimate and outdated. If you were misled into installing it, leave a 1 star review, uninstall it, and report it. An official one will exist eventually.`}
    </div>
);
