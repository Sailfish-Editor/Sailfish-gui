...
const hosts = [
    {
        name: 'US East',
        cloudHost: 'wss://clouddata.sailfish.org'
    },
    {
        name: 'EU',
        cloudHost: 'wss://clouddata-eu.sailfish.org',
        provider: {
            name: '9gr',
        ...
        <div className={styles.badge}>
            ...
            {selectedHost ? (
                ...
                <FormattedMessage
                    ...
                    // eslint-disable-next-line max-len
                    description="Appears when using a non-Sailfish provided cloud variable server. {server} is replaced with the server's URL, eg. wss://clouddata.sailfish.org"
            ...
            <a
                target="_blank"
                rel="noreferrer"
                href="https://docs.sailfish.org/cloud-variables"
            >
                <FormattedMessage
