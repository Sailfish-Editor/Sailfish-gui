        ...
        <div className={styles.footerContent}>
            <div className={styles.footerText}>
                <FormattedMessage
                    ...
                    description="Disclaimer that Sailfish is not connected to Scratch"
            ...
            <div className={styles.footerColumns}>
                ...
                <div className={styles.footerSection}>
                    <a href="https://desktop.sailfish.org/">
                        {/* Do not translate */}
                        {'Sailfish Desktop'}
                    </a>
                    <a href="https://packager.sailfish.org/">
                        {/* Do not translate */}
                        {'Sailfish Packager'}
                    </a>
                    <a href="https://docs.sailfish.org/embedding">
                        <FormattedMessage
                    ...
                    <a href="https://docs.sailfish.org/url-parameters">
                        <FormattedMessage
                    ...
                    <a href="https://docs.sailfish.org/">
                        <FormattedMessage
                ...
                <div className={styles.footerSection}>
                    ...
                    <a href="https://github.com/Sailfish/">
                        <FormattedMessage
                                    ...
                                    <p>
                                        <FormattedMessage
                                            ...
                                            values={{
                                                link: (
                                                    <a
                                                        href="https://docs.sailfish.org/unshared-projects"
                                                        target="_blank"
                                                        rel="noopener noreferrer"
                                                    >
                                                        {'https://docs.sailfish.org/unshared-projects'}
                                                    </a>
                                                )
                                            }}
                                        />
